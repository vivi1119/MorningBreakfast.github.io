...
<%if(session.getAttribute("email")!=null)
{
  ...
  <div id="head">
    <p id="user" style="position:relative; left:600px; top: -5px;  font-face="微軟正黑體"; font-weight: bold;"><%=name%>管理員歡迎進入商品列表</p>
...
<!---放東西的地方--->
<div id="b" style="background-color:#F6E6C5;">

  <div class="c">
  <center>
	<table width="800">
		<tr class="title"><td>商品編號</td><td>商品名稱</td><td>商品類別</td><td>價錢</td><td>庫存</td><td>照片</td><td>銷售量</td></tr>
		
		<%
			sql="select * from product"; //找出會員資料
			ResultSet rs_0 =  con.createStatement().executeQuery(sql);
			while(rs_0.next())
			{
				out.print("<tr>");
				for(int i=1;i<=7;i++)
