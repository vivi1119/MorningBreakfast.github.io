...
<%if(session.getAttribute("email")!=null)
{
  ...
  <div id="head">
    <p id="user" style="position:relative; left:600px; top: -5px;  font-face="微軟正黑體"; font-weight: bold;"><%=name%>管理員歡迎進入評論瀏覽</p>
...
<div id="b" style="background-color:#F6E6C5;">
  ...
  <center>
	<table width="800">
		<tr class="title"><td>評論編號</td><td>電子信箱</td><td>評論內容</td><td>留言者</td><td>留言日期</td></tr>
		
		<%
			sql="select * from board"; //找出會員資料
