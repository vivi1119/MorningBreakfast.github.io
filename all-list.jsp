...
<%if(session.getAttribute("email")!=null)
{
  ...
  <div id="head">
    <p id="user" style="position:relative; left:600px; top: -5px;  font-face="微軟正黑體"; font-weight: bold;"><%=name%>管理員歡迎進入訂單列表</p>
...
<div id="b" style="background-color:#F6E6C5;" >
  ...
  <div class="c"  >
  	<center> 
	<table width="800">
		<tr class="title"><td>訂單編號</td><td>客戶email</td><td>產品名稱</td><td>訂購數量</td><td>產品單價</td><td>訂單總額</td><td>顧客姓名</td><td>訂單狀態</td></tr>
		
		<%
				sql="select * from allyoubought"; //找出商品資料
				ResultSet rs =  con.createStatement().executeQuery(sql);
				while(rs.next())
				{
					out.print("<tr>");
