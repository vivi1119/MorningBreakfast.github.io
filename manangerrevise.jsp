...
<%if(session.getAttribute("email")!=null)
{
  ...
  <div id="head">
    <p id="user" style="position:relative; left:600px; top: -5px;  font-face="微軟正黑體"; font-weight: bold;"><%=name%>管理員歡迎進入修改管理員頁面</p>
...
<!---放東西的地方--->
	<% String sql_2="select * from manager where email='"+session.getAttribute("email")+"'"; 
	...
	<form action="updatem.jsp" method="GET" >
    <div id="ee">
      <div id="ee2">
         &ensp;您的E-mail<p>
        <input type="text" id="input1" name="email" value=<%=rs_0.getString(3)%> readonly="readonly" >
      </div>
      <div id="ee2">
         &ensp;您的姓名<p>
        <input type="text" id="input1" name="name" value=<%=rs_0.getString(2)%> >
      </div>
      
       <div id="ee2">
        &ensp;您的新密碼<p>
        <input type="password" id="input1" name="newone" >
      </div>

      <div id="ee2">
         &ensp;確認您的新密碼<p>
        <input type="password" id="input1" name="newtwo">
      </div>
