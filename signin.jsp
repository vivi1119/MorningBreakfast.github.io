...
<body style="background-color:#FFE082 ;overflow-x: hidden;overflow-y: hidden; ">
...
<div class="form-bg sign">
    <div class="container">
        <div class="row">
            <div class="col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6">

                <form class="form-horizontal" method="GET" action="checktest.jsp">
                    <div class="heading">Login Form</div>
                    <div class="form-group">
                        <i class="fa fa-user"></i><input required="" name="email" type="email" class="form-control" placeholder="Email" id="exampleInputEmail1">
                    </div>
                    <div class="form-group">
                        <i class="fa fa-lock"></i><input name="password" type="password" class="form-control" placeholder="Password"
						onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" >
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-default"><i class="fa fa-arrow-right"></i></button>
                        <span>Don't have an account? <a href="signup.jsp" class="create_account">Sign up</a></span>
                    </div>
	...
	<img src="img/1.png" class="colorblock">
	<img src="img/2.png" class="colorblock2">
	<img src="img/3.png" class="colorblock3">
	<img src="img/4.png" class="colorblock4">
	<img src="img/5.png" class="colorblock5">
	<img src="img/1.png" class="colorblock6">
	<img src="img/4.png" class="colorblock7">
	<img src="img/2.png" class="colorblock8">
