...
<body style="background-color:#F6E6C5;">
				<%if(session.getAttribute("email")!=null)
				{
					...
					%>
	<div id="head">
    <p id="user"><font face="微軟正黑體" ><b>你好！<%=name%>管理員</b></font></p>
...
<div class="w3-sidebar w3-bar-block w3-light-grey w3-card" style="width:20%;" id="sidebar">
  ...
  <div class="w3-dropdown-hover">
    ...
    <div class="w3-dropdown-content w3-bar-block">
      ...
      <a href="manangerdelete.jsp" class="w3-bar-item w3-button">管理員刪除</a>
...
<table>
	<tr>
		<form action="manangerjsp.jsp" method="post">
		<tr><td><br><b><center><h2><font face="monospace"><b>管理員刪除</b></font></h3></center></br></td></tr>
		<tr><td><input type="text" name="id" required oninvalid="setCustomValidity('請輸入管理員ID');" oninput="setCustomValidity('');" placeholder="請輸入管理員ID" class="padding"></td></tr>
