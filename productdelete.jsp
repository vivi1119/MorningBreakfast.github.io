...
<body style="background-color:#F6E6C5;">
				<%if(session.getAttribute("email")!=null)
				{
					...
					%>
	<div id="head">
    <p id="user" style="position:relative; left:600px; top: -5px;  font-face="微軟正黑體"; font-weight: bold;"><%=name%>管理員歡迎進入刪除商品頁面</p>
...
<table>
	<tr>
		<form action="productjsp.jsp" method="post">
		<tr><td><br><b><center><h2><font face="monospace"><b>商品刪除</b></font></h3></center></br></td></tr>
