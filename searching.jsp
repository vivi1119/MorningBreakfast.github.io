...
<%
                    ...
                    String sqlw = "SELECT id, kinds, price, stock, photo FROM product WHERE  kinds like '%"+keyword+"%' ";

                    ResultSet rec = con.createStatement().executeQuery(sqlw);
                    ...
                    while ( rec.next()) 
					{
						...
						if ( count % 3 == 0 && linereturn != 0  ) {
						out.println( "<div  id=heigh" +printt+ ">" ) ;
						printt++ ;
						yesno = true ;
						}
						count = count + 1 ;
						...
						if ( howmany % 3 == 1 )
							...
							out.println("<div class='div_shadow"+howmany+" div_shadow1'>") ;
